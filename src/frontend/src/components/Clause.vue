<template>
    <div class="row">
        ...
        <div class="col-auto p-0">
            ...
            <select class="form-control" v-model="selectedVariable" id="variable-condition"
        ...
        <div class="col-auto p-0">
            ...
            <select class="form-control" v-model="selectedConnection"
                @change="$emit('updateConnection', selectedConnection)" id="variable-term-connector">
                <option>это</option>
                <option>не это</option>
            </select>
        </div>
        ...
        <div class="col-auto p-0">
            ...
            <select class="form-control" v-model="selectedTerm" @change="$emit('updateTerm', selectedTerm)"
                id="term-condition" v-if="selectedVariable != null">
                <option v-for="term in selectedVariable.type.terms" :key="term.name" :value="term">{{ term.name }}
                </option>
            </select>
        </div>
